            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6 mb-4 mb-md-0">
                        ...
                        <div className="mt-3">
                            <a href="#" className="text-primary me-3 fs-4"><i className="bi bi-facebook"></i></a>
                            <a href="#" className="text-primary me-3 fs-4"><i className="bi bi-twitter"></i></a>
                            <a href="#" className="text-primary me-3 fs-4"><i className="bi bi-instagram"></i></a>
                        </div>
                    </div>
                    ...
                    <div className="col-md-3">
                        <h6>Contact</h6>
                        <ul className="list-unstyled">
                            {/* Icônes de contact en Bleu ALMAYA (text-info) */}
                            <li className="text-white"><i className="bi bi-geo-alt-fill text-info me-2"></i> 123 Rue de l'Agence, Ville, Pays</li>
                            <li className="text-white"><i className="bi bi-envelope-fill text-info me-2"></i> contact@almaya.com</li>
                            <li className="text-white"><i className="bi bi-phone-fill text-info me-2"></i> +1 (234) 567-890</li>
                        </ul>
                    </div>
                </div>
